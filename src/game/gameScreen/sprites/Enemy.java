...
public abstract class Enemy extends NPC {
    ...
    public Enemy(Screen screen, int r, int g, int b, int borderR, int borderG, int borderB, double x1, double y1, double x2, double y2, double maxHp, double speed, double coinsOnDeath) {
