...
public class Wall extends GameObject {
    ...
    public Wall(Screen screen, int hue, double x, double y) {
        super(screen, hue,hue,hue,hue,hue,hue,
                x-HALF_SIZE,y-HALF_SIZE,x+HALF_SIZE,y+HALF_SIZE);
        ObjectInstanceManager.getInstance().addInstance(this,Wall.class);
    }
    public Wall(Screen screen, int hue, double x1, double y1, double x2, double y2) {
        super(screen, hue,hue,hue,hue,hue,hue,
                x1,y1,x2,y2);
        ObjectInstanceManager.getInstance().addInstance(this,Wall.class);
    }
